...
function SpecializedCare() {
  ...
  const careType: any = "Specialized Care";
  ...
  useEffect(() => {
    replacePageName("Specialized Care Services");
  }, []);
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">
                No Specialized Care Services Found
              </h3>
              <p className="text-gray-600">
                No Specialized care services available at the moment.
              </p>
            </div>
          </CardContent>
        </Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {isEditing ? "Edit Specialized Care Service" : "Specialized Care Service"}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...serviceForm}>
