...
function SitterServices() {
  const [isEditing, setIsEditing] = useState(false);
  const [newListItem, setNewListItem] = useState("");

  const careType: any = "Sitter Services";
  ...
  useEffect(() => {
    replacePageName("Sitter Services ");
  }, []);
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">
                No Sitter Services Found
              </h3>
              <p className="text-gray-600">
                No Sitter Services available at the moment.
              </p>
            </div>
          </CardContent>
        </Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {isEditing ? "Edit Sitter Services" : "Sitter Services"}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...serviceForm}>
