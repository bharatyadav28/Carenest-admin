...
function CompanionCare() {
  ...
  const careType: any = "Companion Care";
  ...
  useEffect(() => {
    replacePageName("Companion Care Services");
  }, []);
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">
                No Companion Care Services Found
              </h3>
              <p className="text-gray-600">
                No Companion care services available at the moment.
              </p>
            </div>
          </CardContent>
        </Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {isEditing ? "Edit Companion Care Service" : "Companion Care Service"}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...serviceForm}>
