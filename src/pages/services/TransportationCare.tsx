...
function TransportationCare() {
  const [isEditing, setIsEditing] = useState(false);
  const [newListItem, setNewListItem] = useState("");

  const careType: any = "Transportation";
  ...
  useEffect(() => {
    replacePageName("Transportation Care Services");
  }, []);
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">
                No Transportation Care Services Found
              </h3>
              <p className="text-gray-600">
                No Transportation care services available at the moment.
              </p>
            </div>
          </CardContent>
        </Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {isEditing ? "Edit Transportation Care Service" : "Transportation Care Service"}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...serviceForm}>
...
export default TransportationCare;