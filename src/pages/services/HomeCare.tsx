...
function HomeCare() {
  ...
  const careType: any = "Home Maker Service";
  ...
  useEffect(() => {
    replacePageName("Home Care Services");
  }, []);
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">
                No Home care services available at the moment.
              </p>
            </div>
          </CardContent>
        </Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {isEditing ? "Edit Home Care Service" : "Home Care Service"}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...serviceForm}>
